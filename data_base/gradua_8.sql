...
`emp_status` bigint(2) NOT NULL COMMENT '员工状态（1：正常、0：冻结）',
`remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '备注',
`version` bigint(10) NOT NULL COMMENT '乐观锁',
`create_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
`is_delete` bigint(2) NOT NULL COMMENT '是否删除（1：是、0：否）',
PRIMARY KEY (`emp_id`) 
);
CREATE TABLE `dept` (
`dept_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '角色id',
...
`version` bigint(10) NULL COMMENT '乐观锁',
...
`is_show` bigint(2) NULL COMMENT '是否显示（1：是、0：否）',
`version` bigint(10) NULL COMMENT '乐观锁',
`create_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
...
`activ_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '活动id',
...
`views` bigint(10) NULL COMMENT '点击量',
...
CREATE TABLE `clue` (
`clue_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '线索id',
...
`clue_status` bigint(2) NULL COMMENT '线索状态',
`handle_result` bigint(2) NULL COMMENT '处理结果',
...
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`activ_id` bigint(10) NULL COMMENT '活动id',
`emp_id` bigint(10) NULL COMMENT '负责人编号',
PRIMARY KEY (`clue_id`) 
);
CREATE TABLE `customer` (
`cus_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '客户id',
`cus_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '客户名称',
`
life_cycle` bigint(2) NULL COMMENT '生命周期',
...
`settlement` bigint(2) NULL COMMENT '结款方式',
`company_account` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '对公账号',
`province` bigint(10) NULL COMMENT '省（关联地址表id）',
`city` bigint(10) NULL COMMENT '市（关联地址表id）',
`detail_address` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '详细地址',
`version` bigint(10) NULL COMMENT '乐观锁',
`create_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`cus_dict_source` bigint(10) NULL COMMENT '客户来源（dict）',
`cus_dict_stage` bigint(10) NULL COMMENT '客户阶段（dict）',
`qualita_id` bigint(10) NULL COMMENT '定性id',
`grading_id` bigint(10) NULL COMMENT '定级id',
`ration_id` bigint(10) NULL COMMENT '定量id',
`emp_id` bigint(10) NULL COMMENT '负责人id',
PRIMARY KEY (`cus_id`) 
);
CREATE TABLE `qualitative` (
`qualita_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '定性id',
`qualita_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '定性名称',
PRIMARY KEY (`qualita_id`) 
);
CREATE TABLE `grading` (
`grading_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '定级id',
`grading_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '定级名称',
PRIMARY KEY (`grading_id`) 
);
CREATE TABLE `ration` (
`ration_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '定量id',
`expect_signing_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '预计签约日期',
`expect_signing_peice` bigint(10) NULL COMMENT '预计签约金额',
PRIMARY KEY (`ration_id`) 
);
CREATE TABLE `contacts` (
`contacts_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
`update_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`contacts_dict_type` bigint(10) NULL COMMENT '联系人类型',
`cus_id` bigint(10) NULL COMMENT '客户id',
...
`update_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`emp_id` bigint(10) NULL COMMENT '负责人',
`cus_id` bigint(10) NULL COMMENT '客户id',
PRIMARY KEY (`follow_id`) 
);
CREATE TABLE `sales_leads` (
`sale_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '机会id',
`sale_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '机会名称',
`sale_status` bigint(2) NULL COMMENT '销售机会状态',
`discovery_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '发现时间',
`star_beacon` bigint(4) NULL COMMENT '星标',
`version` bigint(10) NULL COMMENT '乐观锁',
`create_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
`is_delete` varchar(255) NULL COMMENT '是否删除（1：是、0：否）',
`sales_dict_status` bigint(10) NULL COMMENT '销售机会状态',
`sales_dict_type` bigint(10) NULL COMMENT '销售机会类型',
`sales_dict_source` bigint(10) NULL COMMENT '销售机会来源',
`sales_dict_stage` bigint(10) NULL COMMENT '销售机会阶段',
`cus_id` bigint(10) NULL COMMENT '客户id',
`contacts_id` bigint(10) NULL COMMENT '客户联系人',
`emp_id` bigint(10) NULL COMMENT '负责人',
PRIMARY KEY (`sale_id`) 
);
CREATE TABLE `demand` (
...
`solu_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`cus_id` bigint(10) NULL COMMENT '客户id',
`sale_id` bigint(10) NULL COMMENT '对应机会',
`solut_dict_status` bigint(10) NULL COMMENT '解决方案状态',
PRIMARY KEY (`solu_id`) 
);
CREATE TABLE `competitor` (
`com_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`cus_id` bigint(10) NULL COMMENT '客户id',
`sale_id` bigint(10) NULL COMMENT '销售机会id',
`demand_id` bigint(10) NULL COMMENT '项目（需求）id',
PRIMARY KEY (`com_id`) 
);
CREATE TABLE `offer` (
`offer_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`cus_id` bigint(10) NULL COMMENT '客户id',
`contacts_id` bigint(10) NULL COMMENT '报价人（客户联系人）',
`sale_id` bigint(10) NULL COMMENT '销售机会id',
`offer_dict_status` bigint(10) NULL COMMENT '报价审核状态',
PRIMARY KEY (`offer_id`) 
);
CREATE TABLE `offer_details` (
`off_det_id` bigint(10) NOT NULL AUTO_INCREMENT,
`off_det_count` bigint(10) NULL COMMENT '数量',
...
`update_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
`is_delete` bigint(2) NULL COMMENT '是否删除（1：是、0：否）',
`offer_id` bigint(10) NULL COMMENT '报价id',
`contacts_id` bigint(10) NULL COMMENT '联系人',
`product_id` bigint(10) NULL COMMENT '产品id',
...
CREATE TABLE `dict` (
`dict_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '字典id',
...
`pid` bigint(10) NULL COMMENT '父级编号',
`version` bigint(10) NULL COMMENT '乐观锁',
`create_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
`is_delete` bigint(2) NULL COMMENT '是否删除',
PRIMARY KEY (`dict_id`) 
);
CREATE TABLE `sys_location` (
`loca_id` bigint(20) NOT NULL AUTO_INCREMENT,
`name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
`fid` bigint(20) NULL,
`language` bigint(11) NOT NULL,
PRIMARY KEY (`loca_id`) ,
