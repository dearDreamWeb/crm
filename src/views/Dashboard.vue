      ...
      <el-col :span="24">
        <el-card>
          ...
          >
            ...
            <el-table-column
              prop="customerResp.cusName"
              label="对应客户"
            ></el-table-column>
            <el-table-column prop="repairSfzb" label="联系人"></el-table-column>
            <el-table-column
              prop="szOrder.ordPhone"
              label="手机号码"
            ></el-table-column>
            <el-table-column
              prop="szOrder.ordConsignee"
              label="联系人"
            ></el-table-column>
            <el-table-column
              prop="deptResp.deptName"
              label="维修部门"
            ></el-table-column>
            <el-table-column
              prop="szOrder.ordTheme"
              label="维修产品"
            ></el-table-column>
            <el-table-column
              prop="repairFault"
            ...
            ></el-table-column>
            <el-table-column
              prop="empResp.empName"
              label="维修人"
            ></el-table-column>
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button
                  v-if="scope.row.repairGdstate == '已派单'"
                  :disabled="
                    scope.row.repairHfjl != null &&
                      scope.row.repairHfjl == '已付款'
                  "
                  @click="openAddDialog(scope.row.repairId)"
                  >付款</el-button
                >
        ...
        <el-dialog :visible.sync="Changp" @closed="closeDialog">
          ...
          <el-pagination
            ...
            :current-page="fukuan.pageNum"
            :page-sizes="[1, 2, 5, 10]"
            :page-size="fukuan.pageSize"
            :total="fukuan.total"
            layout="prev, pager, next, jumper, total"
          >
          </el-pagination>
            ...
            <el-table-column width="80" label="操作">
              <template slot-scope="scope">
                <el-button
                  ...
                  icon="el-icon-delete"
                  circle
                  @click="deleteProduct(scope.$index, scope.row.productPrice)"
                  :disabled="isDisable"
                ></el-button>
              </template>
            </el-table-column>
