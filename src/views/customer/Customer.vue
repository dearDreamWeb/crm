            ...
            <el-row>
              ...
              <el-col :span="10">
                <el-form-item label="简称" prop="abbreviation">
                  <el-input
                    v-model="searchForm.abbreviation"
                    clearable
                    size="mini"
                  ></el-input>
                </el-form-item>
              ...
              <el-col :span="10">
                <el-form-item label="生命周期" prop="lifeCycle">
                  <el-select
                    v-model="searchForm.lifeCycle"
                    clearable
                    size="mini"
                  >
                    <el-option
                      v-for="item in cusLifeCycleList"
                      :key="item.dictId"
                      :label="item.dictName"
                      :value="item.dictId"
                    ></el-option>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="客户来源" prop="cusDictSource">
                  <el-select
                    v-model="searchForm.cusDictSource"
                    size="mini"
                    placeholder="请选择"
                    clearable
                  >
                    <el-option
                      v-for="item in cusSourceList"
                      :key="item.dictId"
                      :label="item.dictName"
                      :value="item.dictId"
                    ></el-option>
              ...
              <el-col :span="8">
                <el-form-item label="客户阶段" prop="cusDictStage">
                  <el-select
                    v-model="searchForm.cusDictStage"
                    size="mini"
                    placeholder="请选择"
                    clearable
                  >
                    <el-option
                      v-for="item in cusStageList"
                      :key="item.dictId"
                      :label="item.dictName"
                      :value="item.dictId"
                    ></el-option>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="首次签约">
                  <el-date-picker
                    format="yyyy-MM-dd"
                    v-model="searchForm.starSigningDate"
                  ...
                  <el-date-picker
                    format="yyyy-MM-dd"
                    v-model="searchForm.endSigningDate"
                    value-format="yyyy-MM-dd"
                    type="date"
                    style="width: 46%"
                    placeholder="请输入"
            ...
            <el-row :gutter="20">
              <el-col :span="6">
                <el-form-item label="结款方式" prop="settlement">
                  ...
                  >
                    <el-option
                      v-for="item in cusSettlementList"
                      :key="item.dictId"
                      :label="item.dictName"
                      :value="item.dictId"
                    ></el-option>
        ...
        <el-row>
          <el-col>
            <el-form-item label="备注" prop="cusRemark">
              <el-input
                type="textarea"
                v-model="addForm.cusRemark"
                clearable
                placeholder="备注说明（联系人）"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="对公账号" prop="companyAccount">
              <el-input
                v-model="editForm.companyAccount"
                clearable
                placeholder="请输入"
              ></el-input>
            </el-form-item>
